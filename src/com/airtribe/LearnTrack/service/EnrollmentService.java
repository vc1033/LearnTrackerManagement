...
public class EnrollmentService {
    ...
    public void enrollStudent(int studentId, int courseId) {
        ...
        enrollments.add(new Enrollment(IdGenerator.getNextEnrollmentId(), studentId, courseId));
    }
    ...
    public void getEnrollmentByStudentId(int studentId) {
        ...
        System.out.println(enrollment.getEnrollmentId() + " " + studentService.getStudentById(studentId) + " " + courseService.getCourseById(enrollment.getCourseId()) + "" + enrollment.getEnrollmentDate() + " " + enrollment.getStatus());
    }
